    ...
    return (
      <div>
        <div className='subnav'>
          <Link className='subnav-links' to='/about' ><h3>About</h3></Link>
          <Link className='subnav-links' to='/about/history' ><h3>History</h3></Link>
          <Link className='subnav-links' to='/about/contact' ><h3>Contact</h3></Link>
        </div>
        <div className='box'>
          <Switch>
